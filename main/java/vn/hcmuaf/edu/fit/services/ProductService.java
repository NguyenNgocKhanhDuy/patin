...
public class ProductService {
    ...
    public List<Product> getProductPerPage(int currentPage, String sort, int quantityPerPage) {
    ...
    public List<Product> getWishList(int userID, int productID) {
        return ProductDao.getInstance().getWishList(userID, productID);
    }

    public void addWishList(int userID, int productID) {
        ProductDao.getInstance().addWishList(userID, productID);
    }

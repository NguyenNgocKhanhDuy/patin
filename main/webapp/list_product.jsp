...
<%--                            <input type="range" id="min" class="range-min" min="0" max="10000000" value="${min != null ? min : 0}" oninput="rangeSlider()">--%>
<%--                            <input type="range" id="max" class="range-max" min="0" max="10000000" value="${max != null ? max : 10000000}" oninput="rangeSlider()">--%>
<%--                        </div>--%>
                    </div>
                    <div class="color">
                        <h3>Màu sắc</h3>

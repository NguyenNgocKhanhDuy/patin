                ...
                <div class="price">
                    ...
                    <div class="price-input">
                        <div class="field">
                            ...
                            <input type="currency" id="text-min" min="0" max="10000000" name="min"
                                   value="${min != null ? min : 0}" step="10000">

                        </div>
                        <div class="separator"></div>
                        <div class="field">
                            <span>Giá cao nhất</span>
                            <input type="currency" id="text-max" min="0" max="10000000" name="max"
                                   value="${max != null ? max : 10000000}" step="10000">
                        </div>
                    </div>
                </div>
                <div class="color">
                    ...
                    <div class="color-box">
                        <div class="color-item">
                            <label>Đen</label>
                            <input type="checkbox" ${colors.contains("2") ? "checked":""} class="check-color" value="2"
                                   name="color" id="black" onchange="changeBG(this)">
                        </div>
                        <div class="color-item">
                            <label>Trắng</label>
                            <input type="checkbox" ${colors.contains("1") ? "checked":""} class="check-color" value="1"
                                   name="color" id="white" onchange="changeBG(this)">
                        </div>
                        <div class="color-item">
                            <label>Đỏ</label>
                            <input type="checkbox" ${colors.contains("8") ? "checked":""} class="check-color" value="8"
                                   name="color" id="red" onchange="changeBG(this)">
                        </div>
                        <div class="color-item">
                            <label>Hồng</label>
                            <input type="checkbox" ${colors.contains("3") ? "checked":""} class="check-color" value="3"
                                   name="color" id="pink" onchange="changeBG(this)">
                        </div>
                        <div class="color-item">
                            <label>Xanh dương</label>
                            <input type="checkbox" ${colors.contains("4") ? "checked":""} class="check-color" value="4"
                                   name="color" id="blue" onchange="changeBG(this)">
                        </div>
                        <div class="color-item">
                            <label>Vàng</label>
                            <input type="checkbox" ${colors.contains("6") ? "checked":""} class="check-color" value="6"
                                   name="color" id="yellow" onchange="changeBG(this)">
                        </div>
                    </div>
                </div>
                            ...
                            <div class="product-item">
                                ...
                                <c:if test="${product.getProductDetail().getProduct().getSalePercent() != 0}">
                                    <div class="sale">
                                        <p>
                                            <fmt:formatNumber
                                                    value="${product.getProductDetail().getProduct().getSalePercent()}"
                                                    type="percent"/>
                                        </p>

...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/patin/assets/css/verifyEmail.css">
</head>
<body>
    <div class="container">
        <form action="/patin_shop/doVerifyEmail" class="wrapper">
            <h3>Xác thực email</h3>
            <p>Chúng tôi vừa gửi đến email user@domain một mã xác thực
                <br>Hãy kiểm tra email và điền vào bên dưới để xác thực email của bạn</p>
            <div class="code-container">
                <input class="code" type="number" min="0" max="9" required>
                <input class="code" type="number" min="0" max="9" required>
                <input class="code" type="number" min="0" max="9" required>
                <input class="code" type="number" min="0" max="9" required>
                <input class="code" type="number" min="0" max="9" required>
...
<script src="${pageContext.request.contextPath}/patin/assets/js/verifyEmail.js"></script>
</body>
</html>

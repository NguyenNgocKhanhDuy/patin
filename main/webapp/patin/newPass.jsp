...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/patin/assets/css/newPass.css">
...
<body>
    ...
    <script src="${pageContext.request.contextPath}/patin/assets/js/newPass.js"></script>
</body>
